...
namespace Ui {
	void MainWindowRibbon::setupRibbonUi(QMainWindow* MainWindow)
	{
		...
		// the actions have initialized but not installed anywhere
		{
			...
			QIcon icon;
			icon.addFile(QString::fromUtf8(":/QUI/icon/createNew.png"), QSize(), QIcon::Normal,
						 QIcon::Off);
			actionNew->setIcon(icon);
			actionOpen = new QAction(MainWindow);
			actionOpen->setObjectName(QString::fromUtf8("actionOpen"));
			QIcon icon1;
			icon1.addFile(QString::fromUtf8(":/QUI/icon/open.png"), QSize(), QIcon::Normal,
						  QIcon::Off);
			...
			QIcon icon2;
			icon2.addFile(QString::fromUtf8(":/QUI/icon/save.png"), QSize(), QIcon::Normal,
						  QIcon::Off);
			actionSave->setIcon(icon2);
			actionClose = new QAction(MainWindow);
			actionClose->setObjectName(QString::fromUtf8("actionClose"));
			QIcon icon3;
			icon3.addFile(QString::fromUtf8(":/QUI/icon/stop.png"), QSize(), QIcon::Normal,
						  QIcon::Off);
			...
			QIcon icon4;
			icon4.addFile(QString::fromUtf8(":/QUI/icon/saveAs.png"), QSize(), QIcon::Normal,
						  QIcon::Off);
			...
			QIcon icon5;
			icon5.addFile(QString::fromUtf8(":/QUI/icon/chinese_language.png"), QSize(),
			...
			QIcon icon6;
			icon6.addFile(QString::fromUtf8(":/QUI/icon/english_language.png"), QSize(),
						  QIcon::Normal, QIcon::Off);
			...
			QIcon icon7;
			icon7.addFile(QString::fromUtf8(":/QUI/icon/importMesh.png"), QSize(), QIcon::Normal,
						  QIcon::Off);
			...
			QIcon icon8;
			icon8.addFile(QString::fromUtf8(":/QUI/icon/importGeometry.png"), QSize(),
						  QIcon::Normal, QIcon::Off);
			...
			QIcon icon9;
			icon9.addFile(QString::fromUtf8(":/QUI/icon/solve.png"), QSize(), QIcon::Normal,
						  QIcon::Off);
			...
			QIcon icon10;
			icon10.addFile(QString::fromUtf8(":/QUI/icon/setting.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon11;
			icon11.addFile(QString::fromUtf8(":/QUI/icon/xPlus.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon12;
			icon12.addFile(QString::fromUtf8(":/QUI/icon/xMinus.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon13;
			icon13.addFile(QString::fromUtf8(":/QUI/icon/yPlus.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon14;
			icon14.addFile(QString::fromUtf8(":/QUI/icon/yMinus.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon15;
			icon15.addFile(QString::fromUtf8(":/QUI/icon/zPlus.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon16;
			icon16.addFile(QString::fromUtf8(":/QUI/icon/zMinus.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon17;
			icon17.addFile(QString::fromUtf8(":/QUI/icon/fit.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon18;
			icon18.addFile(QString::fromUtf8(":/QUI/icon/selectOff.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon19;
			icon19.addFile(QString::fromUtf8(":/QUI/icon/selectNode.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon20;
			icon20.addFile(QString::fromUtf8(":/QUI/icon/selectElement.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon21;
			icon21.addFile(QString::fromUtf8(":/QUI/icon/graphOption.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon22;
			icon22.addFile(QString::fromUtf8(":/QUI/icon/surfaceMesh.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon23;
			icon23.addFile(QString::fromUtf8(":/QUI/icon/solidMesh.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon24;
			icon24.addFile(QString::fromUtf8(":/QUI/icon/exportMesh.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon25;
			icon25.addFile(QString::fromUtf8(":/QUI/icon/help.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionUser_Manual->setIcon(icon25);
			actionAbout = new QAction(MainWindow);
			actionAbout->setObjectName(QString::fromUtf8("actionAbout"));
			QIcon icon26;
			icon26.addFile(QString::fromUtf8(":/QUI/icon/about_us.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon27;
			icon27.addFile(QString::fromUtf8(":/QUI/icon/node.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionDisplayNode->setIcon(icon27);
			actionPreDisplayWireFrame = new QAction(MainWindow);
			actionPreDisplayWireFrame->setObjectName(
				QString::fromUtf8("actionPreDisplayWireFrame"));
			...
			QIcon icon28;
			icon28.addFile(QString::fromUtf8(":/QUI/icon/wireFrame.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon29;
			icon29.addFile(QString::fromUtf8(":/QUI/icon/face.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon30;
			icon30.addFile(QString::fromUtf8(":/QUI/icon/meshComponent.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon31;
			icon31.addFile(QString::fromUtf8(":/QUI/window/2dplot.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon32;
			icon32.addFile(QString::fromUtf8(":/QUI/window/3dgraph.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon33;
			icon33.addFile(QString::fromUtf8(":/QUI/icon/saveScript.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon34;
			icon34.addFile(QString::fromUtf8(":/QUI/icon/execScript.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon35;
			icon35.addFile(QString::fromUtf8(":/QUI/icon/solumationsetting.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon36;
			icon36.addFile(QString::fromUtf8(":/QUI/icon/saveImage.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon37;
			icon37.addFile(QString::fromUtf8(":/QUI/icon/boxNode.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon38;
			icon38.addFile(QString::fromUtf8(":/QUI/icon/boxCell.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon39;
			icon39.addFile(QString::fromUtf8(":/QUI/window/startpage.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon40;
			icon40.addFile(QString::fromUtf8(":/QUI/window/preWindow.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon41;
			icon41.addFile(QString::fromUtf8(":/QUI/icon/meshChecking.png"), QSize(), QIcon::Active,
						   QIcon::On);
			...
			QIcon icon42;
			icon42.addFile(QString::fromUtf8(":/QUI/geometry/box.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon43;
			icon43.addFile(QString::fromUtf8(":/QUI/geometry/cylinder.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon44;
			icon44.addFile(QString::fromUtf8(":/QUI/geometry/sphere.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon iconGear;
			iconGear.addFile(QString::fromUtf8(":/QUI/geometry/gear.png"), QSize(), QIcon::Normal,
							 QIcon::Off);
			actionCreateGear->setIcon(iconGear);
			actionChamfer = new QAction(MainWindow);
			actionChamfer->setObjectName(QString::fromUtf8("actionChamfer"));
			QIcon icon45;
			icon45.addFile(QString::fromUtf8(":/QUI/geometry/chamfer.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionChamfer->setIcon(icon45);
			actionFillet = new QAction(MainWindow);
			actionFillet->setObjectName(QString::fromUtf8("actionFillet"));
			QIcon icon46;
			icon46.addFile(QString::fromUtf8(":/QUI/geometry/fillet.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon47;
			icon47.addFile(QString::fromUtf8(":/QUI/geometry/cut.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon48;
			icon48.addFile(QString::fromUtf8(":/QUI/geometry/fuse.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon49;
			icon49.addFile(QString::fromUtf8(":/QUI/geometry/common.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionBoolCommon->setIcon(icon49);
			actionUndo = new QAction(MainWindow);
			actionUndo->setObjectName(QString::fromUtf8("actionUndo"));
			QIcon icon50;
			icon50.addFile(QString::fromUtf8(":/QUI/geometry/undo.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionUndo->setIcon(icon50);
			actionRedo = new QAction(MainWindow);
			actionRedo->setObjectName(QString::fromUtf8("actionRedo"));
			QIcon icon51;
			icon51.addFile(QString::fromUtf8(":/QUI/geometry/redo.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon52;
			icon52.addFile(QString::fromUtf8(":/QUI/icon/exportGeometry.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon53;
			icon53.addFile(QString::fromUtf8(":/QUI/geometry/cone.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon54;
			icon54.addFile(QString::fromUtf8(":/QUI/geometry/mirror.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon55;
			icon55.addFile(QString::fromUtf8(":/QUI/geometry/variableFillet.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon56;
			icon56.addFile(QString::fromUtf8(":/QUI/geometry/extrude.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon57;
			icon57.addFile(QString::fromUtf8(":/QUI/geometry/point.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon58;
			icon58.addFile(QString::fromUtf8(":/QUI/geometry/line.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon59;
			icon59.addFile(QString::fromUtf8(":/QUI/geometry/face.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon60;
			icon60.addFile(QString::fromUtf8(":/QUI/geometry/move.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon61;
			icon61.addFile(QString::fromUtf8(":/QUI/geometry/Rotate.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon62;
			icon62.addFile(QString::fromUtf8(":/QUI/geometry/revolve.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionRevol->setIcon(icon62);
			actionLoft = new QAction(MainWindow);
			actionLoft->setObjectName(QString::fromUtf8("actionLoft"));
			QIcon icon63;
			icon63.addFile(QString::fromUtf8(":/QUI/geometry/loft.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon64;
			icon64.addFile(QString::fromUtf8(":/QUI/icon/datumPlane.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon65;
			icon65.addFile(QString::fromUtf8(":/QUI/icon/sketchLine.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon66;
			icon66.addFile(QString::fromUtf8(":/QUI/icon/sketchRectangle.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon67;
			icon67.addFile(QString::fromUtf8(":/QUI/icon/sketchCircle.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon68;
			icon68.addFile(QString::fromUtf8(":/QUI/icon/createSketch.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon69;
			icon69.addFile(QString::fromUtf8(":/QUI/icon/sketchArc.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon70;
			icon70.addFile(QString::fromUtf8(":/QUI/icon/sketchPolyLine.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon71;
			icon71.addFile(QString::fromUtf8(":/QUI/geometry/matrix.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionMakeMatrix->setIcon(icon71);
			actionSweep = new QAction(MainWindow);
			actionSweep->setObjectName(QString::fromUtf8("actionSweep"));
			QIcon icon72;
			icon72.addFile(QString::fromUtf8(":/QUI/geometry/sweep.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon73;
			icon73.addFile(QString::fromUtf8(":/QUI/icon/sketchSpline.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon74;
			icon74.addFile(QString::fromUtf8(":/QUI/geometry/pointDisplay.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon75;
			icon75.addFile(QString::fromUtf8(":/QUI/geometry/edgeDisplay.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon76;
			icon76.addFile(QString::fromUtf8(":/QUI/geometry/facedisplay.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon77;
			icon77.addFile(QString::fromUtf8(":/QUI/geometry/selectpoint.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon78;
			icon78.addFile(QString::fromUtf8(":/QUI/geometry/selectwire.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon79;
			icon79.addFile(QString::fromUtf8(":/QUI/geometry/selectface.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon80;
			icon80.addFile(QString::fromUtf8(":/QUI/geometry/selectbody.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon81;
			icon81.addFile(QString::fromUtf8(":/QUI/icon/pluginManager.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon82;
			icon82.addFile(QString::fromUtf8(":/QUI/icon/userguidance.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon83;
			icon83.addFile(QString::fromUtf8(":/QUI/geometry/geoMeasure.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon84;
			icon84.addFile(QString::fromUtf8(":/QUI/geometry/geoSSplit.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon85;
			icon85.addFile(QString::fromUtf8(":/QUI/geometry/geoComponent.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon86;
			icon86.addFile(QString::fromUtf8(":/QUI/icon/meshFluid.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon87;
			icon87.addFile(QString::fromUtf8(":/QUI/icon/meshFilter.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon88;
			icon88.addFile(QString::fromUtf8(":/QUI/geometry/geoFillHole.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon89;
			icon89.addFile(QString::fromUtf8(":/QUI/geometry/geoRemoveFace.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon91;
			icon91.addFile(QString::fromUtf8(":/QUI/icon/meshmodeling.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			iconOpenPostFile.addFile(QString::fromUtf8(":/QUI/post/open.png"), QSize(),
									 QIcon::Normal, QIcon::Off);
			...
			QIcon icon92;
			icon92.addFile(QString::fromUtf8(":/QUI/post/rep_point.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionDisplayPoints->setIcon(icon92);
			actionPostDisplayWireframe = new QAction(MainWindow);
			actionPostDisplayWireframe->setObjectName(QString::fromUtf8("actionDisplayWireframe"));
			QIcon icon93;
			icon93.addFile(QString::fromUtf8(":/QUI/post/rep_wireFrame.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			actionPostDisplayWireframe->setIcon(icon93);
			actionDisplaySurfaceWithoutEdge = new QAction(MainWindow);
			actionDisplaySurfaceWithoutEdge->setObjectName(
				QString::fromUtf8("actionDisplaySurfaceWithoutEdge"));
			QIcon icon94;
			icon94.addFile(QString::fromUtf8(":/QUI/post/rep_surface.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			actionDisplaySurfaceWithoutEdge->setIcon(icon94);
			actionDisplaySurfaceWithEdge = new QAction(MainWindow);
			actionDisplaySurfaceWithEdge->setObjectName(
				QString::fromUtf8("actionDisplaySurfaceWithEdge"));
			QIcon icon95;
			icon95.addFile(QString::fromUtf8(":/QUI/post/rep_surfaceWithEdge.png"), QSize(),
						   QIcon::Normal, QIcon::Off);
			...
			QIcon icon96;
			icon96.addFile(QString::fromUtf8(":/QUI/post/vector.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon97;
			icon97.addFile(QString::fromUtf8(":/QUI/post/clip.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon98;
			icon98.addFile(QString::fromUtf8(":/QUI/post/slice.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon icon99;
			icon99.addFile(QString::fromUtf8(":/QUI/post/streamline.png"), QSize(), QIcon::Normal,
						   QIcon::Off);
			...
			QIcon iconISOCurve;
			iconISOCurve.addFile(QString::fromUtf8(":/QUI/post/isocurve.png"), QSize(),
								 QIcon::Normal, QIcon::Off);
			...
			QIcon icon100;
			icon100.addFile(QString::fromUtf8(":/QUI/post/isosurf.png"), QSize(), QIcon::Normal,
							QIcon::Off);
			...
			QIcon icon101;
			icon101.addFile(QString::fromUtf8(":/QUI/post/calculator.png"), QSize(), QIcon::Normal,
							QIcon::Off);
			...
			QIcon icon102;
			icon102.addFile(QString::fromUtf8(":/QUI/post/Reflection.png"), QSize(), QIcon::Normal,
							QIcon::Off);
			...
			QIcon icon103;
			icon103.addFile(QString::fromUtf8(":/QUI/post/saveImage.png"), QSize(), QIcon::Normal,
							QIcon::Off);
			...
			QIcon icon104;
			icon104.addFile(QString::fromUtf8(":/QUI/post/video.png"), QSize(), QIcon::Normal,
							QIcon::Off);
			...
			QIcon icon105;
			icon105.addFile(QString::fromUtf8(":/QUI/icon/vector.png"), QSize(), QIcon::Normal,
							QIcon::Off);
	...
	void MainWindowRibbon::retranslateRibbonUi(QMainWindow* MainWindow)
	{
		// BaseUi::retranslateUi()
		{
			MainWindow->setWindowTitle(
				QCoreApplication::translate("MainWindow", "FastCAE", nullptr));
			...
			actionSaveAs->setShortcut(
				QCoreApplication::translate("MainWindow", "Ctrl+Shift+S", nullptr));
#endif // QT_CONFIG(shortcut)
			actionChinese->setText(QCoreApplication::translate("MainWindow", "Chinese", nullptr));
#if QT_CONFIG(tooltip)
			actionChinese->setToolTip(
				QCoreApplication::translate("MainWindow", "Chinese", nullptr));
#endif // QT_CONFIG(tooltip)
			actionEnglish->setText(QCoreApplication::translate("MainWindow", "English", nullptr));
#if QT_CONFIG(tooltip)
			actionEnglish->setToolTip(
				QCoreApplication::translate("MainWindow", "English", nullptr));
#endif // QT_CONFIG(tooltip)
			actionImportMesh->setText(
				QCoreApplication::translate("MainWindow", "Import Mesh", nullptr));
#if QT_CONFIG(shortcut)
			actionImportMesh->setShortcut(
				QCoreApplication::translate("MainWindow", "Ctrl+I", nullptr));
#endif // QT_CONFIG(shortcut)
			actionImportGeometry->setText(
				QCoreApplication::translate("MainWindow", "Import Geometry", nullptr));
#if QT_CONFIG(shortcut)
			actionImportGeometry->setShortcut(
				QCoreApplication::translate("MainWindow", "Ctrl+G", nullptr));
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
			actionSolver_Manager->setText(
				QCoreApplication::translate("MainWindow", "Solver Manager", nullptr));
			actionViewXPlus->setText(
				QCoreApplication::translate("MainWindow", "ViewXPlus", nullptr));
			actionViewXMinus->setText(
				QCoreApplication::translate("MainWindow", "ViewXMinus", nullptr));
			actionViewYPlus->setText(
				QCoreApplication::translate("MainWindow", "ViewYPlus", nullptr));
			actionViewYMinus->setText(
				QCoreApplication::translate("MainWindow", "ViewYMinus", nullptr));
			actionViewZPlus->setText(
				QCoreApplication::translate("MainWindow", "ViewZPlus", nullptr));
			actionViewZMinus->setText(
				QCoreApplication::translate("MainWindow", "ViewZMinus", nullptr));
			actionFitView->setText(QCoreApplication::translate("MainWindow", "FitView", nullptr));
			actionSelectOff->setText(
				QCoreApplication::translate("MainWindow", "selectOff", nullptr));
			actionSelectMeshNode->setText(
				QCoreApplication::translate("MainWindow", "selectMeshNode", nullptr));
			actionSelectMeshCell->setText(
				QCoreApplication::translate("MainWindow", "selectMeshCell", nullptr));
			actionSolve_Options->setText(
				QCoreApplication::translate("MainWindow", "Solve Options", nullptr));
			actionGraph_Options->setText(
				QCoreApplication::translate("MainWindow", "Graph Options", nullptr));
			actionSurfaceMesh->setText(
				QCoreApplication::translate("MainWindow", "SurfaceMesh", nullptr));
			actionSolidMesh->setText(
				QCoreApplication::translate("MainWindow", "SolidMesh", nullptr));
			actionExportMesh->setText(
				QCoreApplication::translate("MainWindow", "Export Mesh", nullptr));
#if QT_CONFIG(shortcut)
			actionExportMesh->setShortcut(
				QCoreApplication::translate("MainWindow", "Ctrl+E", nullptr));
#endif // QT_CONFIG(shortcut)
			actionUser_Manual->setText(
				QCoreApplication::translate("MainWindow", "User Manual", nullptr));
			actionAbout->setText(QCoreApplication::translate("MainWindow", "About", nullptr));
			actionDisplayNode->setText(
				QCoreApplication::translate("MainWindow", "DisplayNode", nullptr));
			actionPreDisplayWireFrame->setText(
				QCoreApplication::translate("MainWindow", "DisplayWireFrame", nullptr));
			actionDisplaySurface->setText(
				QCoreApplication::translate("MainWindow", "DisplaySurface", nullptr));
//			actionDisplaySurfaceEdge->setText(QCoreApplication::translate("MainWindow",
//"DisplaySurfaceEdge", nullptr));
#if QT_CONFIG(tooltip)
//			actionDisplaySurfaceEdge->setToolTip(QCoreApplication::translate("MainWindow",
//"DisplaySurfaceEdge", nullptr));
#endif // QT_CONFIG(tooltip)
			actionCreate_Set->setText(
				QCoreApplication::translate("MainWindow", "Create Set", nullptr));
			...
			actionSave_Script->setText(
				QCoreApplication::translate("MainWindow", "Save Script", nullptr));
			actionExecute_Script->setText(
				QCoreApplication::translate("MainWindow", "Execute Script", nullptr));
#if QT_CONFIG(shortcut)
			actionExecute_Script->setShortcut(
				QCoreApplication::translate("MainWindow", "Ctrl+R", nullptr));
#endif // QT_CONFIG(shortcut)
			actionGenMesh->setText(QCoreApplication::translate("MainWindow", "GenMesh", nullptr));
			actionSave_Picture->setText(
				QCoreApplication::translate("MainWindow", "Save Picture", nullptr));
			actionBoxMeshNode->setText(
				QCoreApplication::translate("MainWindow", "BoxMeshNode", nullptr));
			actionBoxMeshCell->setText(
				QCoreApplication::translate("MainWindow", "BoxMeshCell", nullptr));
			actionStart_Page->setText(
				QCoreApplication::translate("MainWindow", "Start Page", nullptr));
			actionPre_Window->setText(
				QCoreApplication::translate("MainWindow", "Pre Window", nullptr));
			actionChecking->setText(QCoreApplication::translate("MainWindow", "Checking", nullptr));
			actionCreateBox->setText(
				QCoreApplication::translate("MainWindow", "CreateBox", nullptr));
			actionCreateCylinder->setText(
				QCoreApplication::translate("MainWindow", "CreateCylinder", nullptr));
			actionCreaterSphere->setText(
				QCoreApplication::translate("MainWindow", "CreaterSphere", nullptr));
			actionCreateGear->setText(
				QCoreApplication::translate("MainWindow", "CreateGear", nullptr));
			...
			actionBoolFause->setText(
				QCoreApplication::translate("MainWindow", "BoolFause", nullptr));
			actionBoolCommon->setText(
				QCoreApplication::translate("MainWindow", "BoolCommon", nullptr));
...
#endif // QT_CONFIG(shortcut)
			actionExportGeometry->setText(
				QCoreApplication::translate("MainWindow", "ExportGeometry", nullptr));
			actionCreaterCone->setText(
				QCoreApplication::translate("MainWindow", "CreaterCone", nullptr));
			actionMirrorFeature->setText(
				QCoreApplication::translate("MainWindow", "MirrorFeature", nullptr));
			actionVariable_Fillet->setText(
				QCoreApplication::translate("MainWindow", "Variable Fillet", nullptr));
			actionExtrude->setText(QCoreApplication::translate("MainWindow", "Extrude", nullptr));
			actionCreate_Point->setText(
				QCoreApplication::translate("MainWindow", "Create Point", nullptr));
			actionCreate_Line->setText(
				QCoreApplication::translate("MainWindow", "Create Line", nullptr));
			actionCreate_Face->setText(
				QCoreApplication::translate("MainWindow", "Create_Surface", nullptr));
			actionMoveFeature->setText(QCoreApplication::translate("MainWindow", "Move", nullptr));
			actionRotateFeature->setText(
			...
			actionCreateDatumPlane->setText(
				QCoreApplication::translate("MainWindow", "Create Datum Plane", nullptr));
			actionDrawLine->setText(QCoreApplication::translate("MainWindow", "DrawLine", nullptr));
			actionDrawRectangle->setText(
				QCoreApplication::translate("MainWindow", "DrawRectangle", nullptr));
			actionDrawCircle->setText(
				QCoreApplication::translate("MainWindow", "DrawCircle", nullptr));
			actionCreate_Sketch->setText(
				QCoreApplication::translate("MainWindow", "Create Sketch", nullptr));
			actionDrawArc->setText(QCoreApplication::translate("MainWindow", "DrawArc", nullptr));
			actionDrawPolyline->setText(
				QCoreApplication::translate("MainWindow", "DrawPolyline", nullptr));
			actionMakeMatrix->setText(
				QCoreApplication::translate("MainWindow", "MakeMatrix", nullptr));
#if QT_CONFIG(tooltip)
			actionMakeMatrix->setToolTip(
				QCoreApplication::translate("MainWindow", "MakeMatrix", nullptr));
#endif // QT_CONFIG(tooltip)
			actionSweep->setText(QCoreApplication::translate("MainWindow", "Sweep", nullptr));
			actionDrawSpline->setText(
				QCoreApplication::translate("MainWindow", "DrawSpline", nullptr));
			actionDisplayPoint->setText(
				QCoreApplication::translate("MainWindow", "DisplayPoint", nullptr));
			actionDisplayCurve->setText(
				QCoreApplication::translate("MainWindow", "DisplayCurve", nullptr));
			actionDisplayFace->setText(
				QCoreApplication::translate("MainWindow", "DisplayFace", nullptr));
			actionSelectPoint->setText(
				QCoreApplication::translate("MainWindow", "SelectPoint", nullptr));
			actionSelectCurve->setText(
				QCoreApplication::translate("MainWindow", "SelectCurve", nullptr));
			actionSelectFace->setText(
				QCoreApplication::translate("MainWindow", "SelectFace", nullptr));
			actionSelectGeometryBody->setText(
				QCoreApplication::translate("MainWindow", "SelectGeometryBody", nullptr));
			actionPluginManager->setText(
				QCoreApplication::translate("MainWindow", "Plugin Manager", nullptr));
#if QT_CONFIG(tooltip)
			actionPluginManager->setToolTip(
				QCoreApplication::translate("MainWindow", "Plugin Manager", nullptr));
#endif // QT_CONFIG(tooltip)
			actionUser_Guidance->setText(
				QCoreApplication::translate("MainWindow", "User Guidance", nullptr));
			actionMeasure_Distance->setText(
				QCoreApplication::translate("MainWindow", "Measure Distance", nullptr));
			...
			actionCreateGeoComponent->setText(
				QCoreApplication::translate("MainWindow", "CreateGeoComponent", nullptr));
			actionFluidMesh->setText(
				QCoreApplication::translate("MainWindow", "FluidMesh", nullptr));
			actionFilterMesh->setText(
				QCoreApplication::translate("MainWindow", "FilterMesh", nullptr));
			...
			actionGeoMeshRotate->setText(
				QCoreApplication::translate("MainWindow", "GeoMeshRotate", nullptr));
			...
			actionOpenPostFile->setText(
				QCoreApplication::translate("MainWindow", "OpenPostFile", nullptr));
			actionDisplayPoints->setText(
				QCoreApplication::translate("MainWindow", "DisplayPoints", nullptr));
			actionPostDisplayWireframe->setText(
				QCoreApplication::translate("MainWindow", "DisplayWireframe", nullptr));
			actionDisplaySurfaceWithoutEdge->setText(
				QCoreApplication::translate("MainWindow", "DisplaySurfaceWithoutEdge", nullptr));
			actionDisplaySurfaceWithEdge->setText(
				QCoreApplication::translate("MainWindow", "DisplaySurfaceWithEdge", nullptr));
			actionCreateVector->setText(
				QCoreApplication::translate("MainWindow", "CreateVector", nullptr));
			actionCreateClip->setText(
				QCoreApplication::translate("MainWindow", "CreateClip", nullptr));
			actionCreateSlice->setText(
				QCoreApplication::translate("MainWindow", "CreateSlice", nullptr));
			actionCreateStreamLine->setText(
				QCoreApplication::translate("MainWindow", "CreateStreamLine", nullptr));
			actionCreateISOCurve->setText(
				QCoreApplication::translate("MainWindow", "CreateISOCurve", nullptr));
			actionCreateISOSurface->setText(
				QCoreApplication::translate("MainWindow", "CreateISOSurface", nullptr));
			actionCreateCalculator->setText(
				QCoreApplication::translate("MainWindow", "CreateCalculator", nullptr));
			actionCreateReflection->setText(
				QCoreApplication::translate("MainWindow", "CreateReflection", nullptr));
			actionSaveImage->setText(
				QCoreApplication::translate("MainWindow", "SaveImage", nullptr));
			actionSaveVideo->setText(
				QCoreApplication::translate("MainWindow", "SaveVideo", nullptr));
#if QT_CONFIG(tooltip)
			actionSaveVideo->setToolTip(
				QCoreApplication::translate("MainWindow", "SaveVideo", nullptr));
#endif // QT_CONFIG(tooltip)
		}
